  ...
  <div class="landing">
    ...
    <div class="landing-form">
      ...
      <div class="form-box login-register-form-element">
        ...
        <!-- /FORM BOX TITLE -->
        <!-- FORM -->
        <form class="form" action="{{URL::to('/admin-dashboard')}}" method="post">
          {{ csrf_field() }}
          ...
          <div class="form-row">
            ...
            <div class="form-item">
              ...
              <div class="form-input">
                ...
                <input type="text" id="login-username" name="admin_email">
              </div>
              <!-- /FORM INPUT -->
            </div> 
            <!-- /FORM ITEM -->
          ...
          <div class="form-row">
            ...
            <div class="form-item">
              ...
              <div class="form-input">
                ...
                <input type="password" id="login-password" name="admin_password">
              </div>
              <!-- /FORM INPUT -->
            </div>
            <!-- /FORM ITEM -->
          ...
          <div class="form-row">
            ...
            <div class="form-item">
              <!-- BUTTON -->
              <button name="login" class="button medium secondary">Login to your Account!</button>
              <!-- /BUTTON -->
            </div>
            <!-- /FORM ITEM -->
          </div>
